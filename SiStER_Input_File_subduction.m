...
Nt=300; % max number of time iterations
...
MAT(1).pre_diff=.5/1e19;
MAT(1).Ediff=0;
MAT(1).ndiff=1;
% dislocation creep parameters
MAT(1).pre_disc=.5/1e19;
MAT(1).Edisc=0;
MAT(1).ndisc=1;
% plasticity
MAT(1).mu=0.6;
...
MAT(2).G=1e18;
% diffusion creep parameters
MAT(2).pre_diff=.5/1e21;
MAT(2).Ediff=0;
MAT(2).ndiff=1;
% dislocation creep parameters
MAT(2).pre_disc=0.5/1e21;
MAT(2).Edisc=0;
MAT(2).ndisc=1;
% plasticity
MAT(2).mu=0.6;
...
MAT(3).G=1e18;
% diffusion creep parameters
MAT(3).pre_diff=.5/1e23;
MAT(3).Ediff=0;
MAT(3).ndiff=1;
% dislocation creep parameters
MAT(3).pre_disc=.5/1e23;
MAT(3).Edisc=0;
MAT(3).ndisc=1;
% plasticity
MAT(3).mu=0.6;
...
MAT(4).G=1e18;
% diffusion creep parameters
MAT(4).pre_diff=.5/1e23;
MAT(4).Ediff=0;
MAT(4).ndiff=1;
% dislocation creep parameters
MAT(4).pre_disc=.5/1e23;
MAT(4).Edisc=0;
MAT(4).ndisc=1;
% plasticity
MAT(4).mu=0.6;

...
BC.DIKE.imposethermal=1; % imposes a thermal condition (see SiStER_impose_thermal_condition for descriptions)
...
PARAMS.customviscofxnswitch=1; % switch on custom viscosity function
PARAMS.customviscofunction = @(temperature) 1*10.^(17+((7/2*(1/7+2/pi*atan((temperature-1)/0.001)))+5/2*(1+2/pi*atan((700-temperature)/10))-2));
%PARAMS.etaMN=18;
%PARAMS.Tc=600;
%PARAMS.Wtan=10;
%PARAMS.etaMX=25;
